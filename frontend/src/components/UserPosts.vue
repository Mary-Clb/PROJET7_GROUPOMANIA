    ...
    <div class="container-post">
        ...
        <article class="post" v-for="post in posts" :key="post.id">
            ...
            <div class="post__header--buttons">   
               ...
               <button id="btn" type="button" class="post__header--buttons-delete" v-if="post.userId == user_id || is_Admin" @click="deletePost(post.id)" alt="supprimer le commentaire" > X </button>
            </div>   
            </div>    
                    <!--TITLE + IMG-->
                            ...
                            <div class="newcomment-container" >
                                  <div class="newcomments">
                                    <form class="newcomments__form">
                                        ...
                                        <button id="btn" class="newcomments__form--btn" type="submit" @click="createComment(post.id)" alt="publier le commentaire"><img src="../assets/send.svg" alt="Envoyer le commentaire"></button>
                                    </form>
                                  </div>
                            </div> 
                        ...
                        <div  v-bind:id="post.id" class="comment-none" >
                            <div class="comment" v-for="comment in post.comments" :key="comment.id" >
                                <div class="comment__username">
                                    ...
                                    <button id="btn" type="button" class="comment__deletebtn" v-if="comment.userId == user_id || is_Admin" @click="deleteComment(comment.id)" alt="supprimer le commentaire" > x </button>
                                </div>
